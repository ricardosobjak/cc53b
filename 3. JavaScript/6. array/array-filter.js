 ...
 */
var array = [5, 1, 9, 5, 2, 3, 4, 1, 1, 2, 3, 3, 2];
var uniqueArrayES5 = array.filter(function (elem, index, array) {
    return array.indexOf(elem) === index;
});
// ES6
var uniqueArrayES6 = array.filter(function (elem, index, originalArray) { return originalArray.indexOf(elem) === index; });
console.log(uniqueArrayES5);
console.log(uniqueArrayES6);
/**
 * EXEMPLO 2: Deixar somente elementos maiores do que 5
 */
var array2 = [5, 1, 9, 5, 2, 3, 4, 1, 1, 2, 3, 3, 2, 7, 6, 7];
var maiorQue5ArrayES6 = array2.filter(function (elem) { return elem > 5; });
...
// Modo de filtro 2
var grandesCidades2 = cidades.filter(function (cidade) { return cidade.populacao > 100000; });
